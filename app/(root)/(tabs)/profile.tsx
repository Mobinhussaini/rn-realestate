...
import { StyleSheet, View,Text, ScrollView, Image, TouchableOpacity, ImageSourcePropType, Alert, ActivityIndicator } from 'react-native';
...
const Profile = () => {
    ...
    const handleLogout= async ()=> {
        ...
        if(result){
            Alert.alert("Success", "You have been sign out"); 
            refetch();  
        }else {
